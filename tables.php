<?php
    ...
    $result = display_data_tables();
    $result_admin = display_id_admins();
?>
...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <!-- Navbar & Hero Start -->
        <div class="container-xl position-relative responsive-xl p-0 py-lg-5 bg-dark" >
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-12 py-3 py-lg-0">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-2">
                    <form class="my-3 px-3 offset-md-3" method="POST" action="add_tables.php">
                        <div class="col-md-11 my-2">
                            <div class="form-floating date" id="date3" data-target-input="nearest">
                                <select class="form-control" name="Admin_id" id="Admin_id" placeholder="Managed by admin" required>
                                    <?php
                                        while($row = mysqli_fetch_assoc($result_admin)){
                                            $adminiid = $row["ID"];
                                            $adminid = $row["ID"];
                                    ?>
                                    <option value="<?php echo $adminiid; ?>"><?php echo $adminid; ?></option> 
                                    <?php
                                        }
                                    ?>
                                </select>
                                <label for="Table_no">Managed by admin</label>
                            </div>
                        </div>
                        <button name="submit" class="btn btn-primary col-8 col-lg-8 col-md-5 col-sm-7 py-3 offset-md-1 offset-2  my-3 animated slideInLeft" type="submit" value="Add">Add</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid ">
            <div class="row">
                <div class="col">
                    <div class="table-responsive-sm table-responsive-md table-responsive-lg table-responsive-xl card-body align-item-center">
                        <table class="table-dark-striped table-bordered text-center offset-xl-2 offset-lg-2">
                            <tr class="bg-dark text-white">
                                <td class="px-5">Table id</td>
                                <td class="px-5">capacity for peoples</td>
                                <td class="px-5">managed by admin#</td>
                                <td class="px-5">booked</td>
                            </tr>
                            <tr>
                                <?php
