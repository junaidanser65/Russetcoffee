...
<body>
    <div class="container-xxl bg-white p-0">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        <a href="panel_booking.php" class="nav-item nav-link active">Bookings</a>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col">
                    <div class="table-responsive-sm table-responsive-md table-responsive-lg card-body justify-content-center">
                        <p class="text-danger"><?php echo $msg; ?></p>
                        <table class="table-dark-striped table-bordered text-center centered-table">
