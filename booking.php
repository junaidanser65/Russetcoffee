                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating date" id="date3" data-target-input="nearest">
                                           <select class="form-control" name="Table_no" id="Table_no" placeholder="Tables" required>
                                                <?php
                                                    while($row = mysqli_fetch_assoc($result)){
                                                        $tableId = $row["Table_id"];
                                                        $tableName = $row["Table_id"];
                                                ?>
                                                <option value="<?php echo $tableId; ?>"><?php echo $tableName; ?></option> 
                                                <?php
                                                    }
                                                ?>
                                            </select>
