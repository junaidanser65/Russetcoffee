<?php
    ...
    $result = display_data_completed_orders();
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        <a href="completed.php" class="nav-item nav-link active">Completed</a>
                    ...
                    <div class="table-responsive-sm table-responsive-md table-responsive-lg card-body">
                        ...
                        <table class="table-dark-striped table-bordered text-center">
                            <tr class="bg-dark text-white">
                                ...
                                <td class="px-3">completed_by_admin_id</td>
                            </tr>
                            <tr>
                                <?php
                                ...
                                <td><?php echo $row['completed_time_date']; ?></td>
                                <td><?php echo $row['completed_by_admin_id']; ?></td>
                            </tr>  
                                <?php
                                    }
                                ?>
