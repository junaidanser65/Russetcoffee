                ...
                <div class="container my-5 py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            <h1 class="display-3 text-white animated slideInLeft">Russet Coffee<br></h1>
                            <p class="text-white animated slideInLeft mb-4 pb-2">Discover the taste of real coffee . . . .</p>
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Master barista</h5>
                                <p>Indulge in an extraordinary coffee experience with our Master Barista. From bean to cup, our barista's expert knowledge and skill ensures the perfect blend, every time.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <p>"Experience the difference of our carefully selected, premium quality coffee beans, expertly roasted to perfection.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Online Order</h5>
                                <p>Start your day right with our quick and easy online ordering system for coffee.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>24/7 Service</h5>
                                <p>we understand that life doesn't always operate on a 9-5 schedule, which is why we offer 24/7 service to our customers.</p>
                            </div>
                        </div>
                    </div>
                </div>
