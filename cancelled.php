<?php
    ...
    $result = display_data_cancelled_orders();
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        <a href="cancelled.php" class="nav-item nav-link active">Cancelled</a>
                    </div>
                    ...
                    <div class="table-responsive-sm table-responsive-md table-responsive-lg card-body">
                        ...
                        <table class="table-dark-striped table-bordered text-center">
                            <tr class="bg-dark text-white">
                                ...
                                <td class="px-3">cancelled_by_admin_id</td>
                            </tr>
                            <tr>
                                <?php
                                ...
                                <td><?php echo $row['cancelled_time_date']; ?></td>
                                <td><?php echo $row['cancelled_by_admin_id']; ?></td>
                            </tr>  
                                <?php
                                    }
                                ?>
