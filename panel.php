            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        <a href="panel.php" class="nav-item nav-link active">Orders</a>
                    ...
                    <div class="table-responsive-sm table-responsive-md table-responsive-lg card-body">
                        ...
                        <table class="table-dark-striped table-bordered text-center">
                            <tr class="bg-dark text-white">
                                ...
                                <td class="px-5">Address</td>
                                <td class="px-3">Phone #</td>
                                <td class="px-3">CAFFE LATTE</td>
                                <td class="px-3">COFFEE MOCHA</td>
                                <td class="px-3">WHITE CHOCOLATE MOCHA</td>
                                <td class="px-3">AMERICAN COFFEE</td>
                                <td class="px-3">Update</td>
                            </tr>
                            <tr>
                                <?php
                                ...
                                <td><?php echo $row['CAFFE_LATTE']; ?></td>
                                <td><?php echo $row['COFFEE_MOCHA']; ?></td>
                                <td><?php echo $row['WHITE_CHOCOLATE_MOCHA']; ?></td>
                                <td><?php echo $row['AMERICAN_COFFEE']; ?></td>
                                <td><a class="btn btn-danger px-3" href="cancel.php?cancelid=<?php echo $row['orderID']; ?>">Cancel</a>
                                <a class="btn btn-primary px-1" href="insert.php?insertid=<?php echo $row['orderID']; ?>">Complete</a></td>
                            </tr>  
                                <?php
                                    }
                                ?>
